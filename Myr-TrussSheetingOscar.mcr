...
/// <version  value="1.16" date="17.09.2018"></version>
...
if( nMaterialIndex == 0 ){
	...
	arDLengthSh.append(U(1200));				arSLabelSh.append("G800");
	arDLengthSh.append(U(1800));				arSLabelSh.append("G818");
	arDLengthSh.append(U(2100));				arSLabelSh.append("G810");
	arDLengthSh.append(U(2400));				arSLabelSh.append("G801");
	arDLengthSh.append(U(3000));				arSLabelSh.append("G802");
	arDLengthSh.append(U(3300));				arSLabelSh.append("G803");
	arDLengthSh.append(U(3600));				arSLabelSh.append("G804");
	arDLengthSh.append(U(3900));				arSLabelSh.append("G805");
	
	arDLengthShOverhang.append(U(0));			arSLabelShOverhang.append("");
	arDLengthShOverhang.append(U(1850));		arSLabelShOverhang.append("G820");
	arDLengthShOverhang.append(U(2150));		arSLabelShOverhang.append("G817");
	arDLengthShOverhang.append(U(2450));		arSLabelShOverhang.append("G819");
	arDLengthShOverhang.append(U(2750));		arSLabelShOverhang.append("G821");
	arDLengthShOverhang.append(U(3050));		arSLabelShOverhang.append("G809");
	arDLengthShOverhang.append(U(3350));		arSLabelShOverhang.append("G808");
	arDLengthShOverhang.append(U(3650));		arSLabelShOverhang.append("G822");

	arSLabelShFirstRow.append(arSLabelSh);
	arSLabelShOverhangFirstRow.append(arSLabelShOverhang);
	
	arDLengthShLastRow.append(U(2400));				arSLabelShLastRow.append("G851");
	arDLengthShLastRow.append(U(3000));				arSLabelShLastRow.append("G852");
	arDLengthShLastRow.append(U(3300));				arSLabelShLastRow.append("G853");
	arDLengthShLastRow.append(U(3600));				arSLabelShLastRow.append("G854");
	arDLengthShLastRow.append(U(3900));				arSLabelShLastRow.append("G855");
	...
	arDLengthShLastRow.append(U(2400));				arSLabelShLastRow.append("G861");
	arDLengthShLastRow.append(U(3000));				arSLabelShLastRow.append("G862");
	arDLengthShLastRow.append(U(3300));				arSLabelShLastRow.append("G863");
	arDLengthShLastRow.append(U(3600));				arSLabelShLastRow.append("G864");
	arDLengthShLastRow.append(U(3900));				arSLabelShLastRow.append("G865");
...
PropString sOddColumnIndex(4, "3;5", T("|Other sheet length in column|"));
...
PropString sLengthShOddColumn(5, "1550;2150", T("|Other length in column|"));
