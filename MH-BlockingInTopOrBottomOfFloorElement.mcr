#Version 8
#BeginDescription
Last modified by: Leif Isacsson 29.05.2009
...
String arSSide[] = {T("Top of Beams (BLO)"), T("Bottom of Beams (BLU)")};
int arNSide[] = {1, -1};
String arSBmCode[] = {"BLO", "BLU"};
PropString sSide(0, arSSide, T("Position of Blocking"),1);
