...
21.10.2019  -  version 1.19

OR - 1.19 - 21.10.2019 - Set SubLabel2 to be empty
...
/// <version  value="1.19" date="21.10.2019"></version>
...
/// LI - 1.15 - 13.01.2011 - Updated for Vägg 2010
/// AS - 1.16 - 11.06.2015 - Add element filters. Add support for execution during generate construction.
/// AS - 1.17 - 11.06.2015 - Only execute tsl on element constructed and on a manual insert.
/// AS - 1.18 - 19.10.2015 - Make grade and beamcode uppercase.
/// OR - 1.19 - 21.10.2019 - Set SubLabel2 to be empty
/// </history>
...
String arSCatalogNames[] = TslInst().getListOfCatalogNames("Myr-T-Connections");
...
if( _bOnElementConstructed || bManualInsert || _bOnDebug ) {
	...
	for( int i=0;i<arElConnected.length();i++ ){
		...
		if (elConnected.exposed()) // we only want internal walls.
			continue;
