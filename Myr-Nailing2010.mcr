...
double dDistanceToTopPlateZn06 = U(225);
//dDistanceToTopPlateZn06 -= dSizeTP;
double arDDistanceToTopPlate[] = {dDistanceToTopPlateZn01, dDistanceToTopPlateZn06};

double dSizeBP = U(54);
double dDistanceToBottomPlateZn01 = U(225);
//dDistanceToBottomPlateZn01 -= dSizeBP;
double dDistanceToBottomPlateZn06 = U(210);
//dDistanceToBottomPlateZn06 -= dSizeBP;
double arDDistanceToBottomPlate[] = {dDistanceToBottomPlateZn01, dDistanceToBottomPlateZn06};
...
PropDouble dDistBetweenNailsZn06(1,U(200),T("Distance between nails zone 6"));
double arDDistBetweenNails[] = {dDistBetweenNailsZn01, dDistBetweenNailsZn06};
...
if( _bOnInsert ){
	...
	dArPropDouble.append(dDistBetweenNailsZn06);
